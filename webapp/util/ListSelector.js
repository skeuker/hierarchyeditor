sap.ui.define([
	...
	return BaseObject.extend("pnp.survey.controller.ListSelector", {
				...
				this._oWhenListHasBeenSet
					.then(function (oList) {
						oList.getBinding("items").attachEventOnce("dataReceived",
							function () {
								if (this.oSelectorList.getItems().length) {
									fnResolve({
										list: oList
									});
								} else {
		...
		clearMasterListSelection: function () {
			//use promise to make sure that 'this.oSelectorList' is available
		...
		refreshMasterListBinding: function () {
			...
			this.oSelectorList.getBinding("items").refresh(true);
